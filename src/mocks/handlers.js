...
export const handlers = [
  rest.post("http://localhost:9002/api/login", login),
  rest.post("http://localhost:9002/api/logout", logout),
  rest.get("http://localhost:9002/api/friends", getAll),
  rest.get("http://localhost:9002/api/friends/:id", getById),
  rest.post("http://localhost:9002/api/articles", create),
];
